...
CREATE POLICY "Auth users" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Auth users" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
